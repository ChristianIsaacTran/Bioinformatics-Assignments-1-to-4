#!/usr/bin/env python3
# =====================================================================
# Title             : Christian_Tran_R11641653_assignment_2.py
# Description       : This program reads command line arguments for input FASTA files, aligns 2 sequences from score matrix and outputs a FASTA style alignment using Needleman-Wunsch
# Author            : Christian Tran (R11641653)
# Date              : 10/10/2023
# Usage             : python3 Christian_Tran_R11641653_assignment_1.py -i <input file path for .fna> -o <output file path for .fna> -s <path for score matrix>
...
def main():
    ...
    aligned_sequences = needlemanWunsch(sequence_1, sequence_2, score_dict)
